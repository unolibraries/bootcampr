...
- Attendance to all workshops is not required, but be aware that I won't have time during the workshops to help troubleshoot technical issues. If you're running into issues during a workshop, you'll likely need to figure out a solution on your own. If you're running into issues outside of the workshop, please set up an appointment with me and we can troubleshoot together.
